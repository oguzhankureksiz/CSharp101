...
Console.WriteLine(DateTime.Now.ToString("ddd")); //Saturdayi - Sat olarak yazar.
Console.WriteLine(DateTime.Now.ToString("dddd")); //Saturday olarak yazar.


Console.WriteLine(DateTime.Now.ToString("MM")); //02
Console.WriteLine(DateTime.Now.ToString("MMM")); //April ise Apr olarak yazar.
Console.WriteLine(DateTime.Now.ToString("MMMMM")); //April olarak yazar.
...
Console.WriteLine(Math.Tan(20));  //Tanjantını alır.<
...
Console.WriteLine(Math.Pow(3,4)); // 3 üzeri 4 getirir.
Console.WriteLine(Math.Sqrt(9));  // karesini alır.
Console.WriteLine(Math.Log(9));   // 9 un e tabanında logaritmik karşılığını getirir.
